...
extension WKUserContentController {
    ...
    // map from controller address -> (injectionTime -> [UserScript])
    ...
    // map from controller address -> (injectionTime -> [PluginScript])
    ...
    public func initialize () {
        ...
        // initialize as empty arrays (preserve insertion order; uniqueness handled on insert/removal)
        pluginScripts = [
            .atDocumentStart: [],
            .atDocumentEnd: [],
        ]
    ...
    public func addUserOnlyScript(_ userOnlyScript: UserScript) {
        ...
        // append preserves insertion order; duplicates may exist if caller adds same script multiple times
    ...
    public func removeUserOnlyScript(_ userOnlyScript: UserScript) {
        // remove all matching scripts by identity or by content
    ...
    public func removePluginScript(_ pluginScript: PluginScript) {
        // remove all matching plugin scripts
